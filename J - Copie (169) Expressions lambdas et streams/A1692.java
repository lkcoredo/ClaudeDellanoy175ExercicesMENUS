...
public class A1692 {
    ...
    {	
        ...
        affichage_selectif	 (tab,	 A1692::filtragePositifs)	 ;	 	 //reference
        System.out.println	("--	Les	negatifs	:	")	;
        affichage_selectif	(tab,	ee	->	ee	<	0)	;																	//	lambda
        affichage_selectif	 (tab,	 A1692::filtrageNegatifs)	 ;	 	 //reference
        System.out.println	("--	Les	pairs	:	")	;
        affichage_selectif	(tab,	ee	->	2	*	(ee/2)	==	ee	)	;						//	lambda
        affichage_selectif	 (tab,	 A1692::filtragePairs)	 ;	 	 	 	 	 //reference
    }
